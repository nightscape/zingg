...
public interface ZFrame<D, R, C> {
    ...
    public ZFrame<D, R, C> repartition(int num,scala.collection.immutable.Seq<C> partitionExprs);
    public ZFrame<D, R, C> repartition(scala.collection.immutable.Seq<C> partitionExprs);
